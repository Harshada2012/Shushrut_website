                    ...
                    <div className="member-card" key={index}>
                        <div className="image-wrapper">
                            ...
                            <div className="hover-overlay">
                                <p className="hover-text">{member.text}</p>
